    ...
    <Container fluid className="project-section">
      ...
      <Container>
        ...
        <Col md={4} className="project-card">
              ...
              description={
                <span
                  dangerouslySetInnerHTML={{
                    ...
                    <br/>
                    - I corrected textures in the environment and added decals to create a more immersive atmosphere. I also implemented optimization adjustments in light baking and occlusion culling to enhance the performance of the scene.<br/>
                    <br/>`,
                  }}
                />
              }
              ...
              description={
                <span
                  dangerouslySetInnerHTML={{
                    ...
                    <br/>
                    - I implemented an advanced set of animations using Mecanim and C# programming, with an Animator Controller managing animation layers and Blend Trees for smooth transitions between movement states (such as walking, running, and specific combat actions). <br/>
                    <br/>`,
                  }}
                />
              }
          ...
          <br/>
          - I implemented a detailed animation system with Unity's Animator Controller and C#, utilizing Blend Trees to handle transitions between movement states such as walking, running, and interacting with objects.<br/>
          <br/>`,
                  }}
                />
              }
